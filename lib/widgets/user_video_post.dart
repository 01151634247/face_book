...
class UserVideoPost extends StatelessWidget {
   String userProfile;
   String userPost;
   String userName;
   String ?postDate;
   ...
   String ?numComment;
   String ?numShare;
  UserVideoPost({super.key,required this.userName,required  this.userProfile,required this.userPost, this.postDate, this.numComment, this.numLikes, this.numShare});
